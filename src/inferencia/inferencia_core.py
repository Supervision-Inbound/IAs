...
# IMPORTACIONES CORRECTAS: Solo desde otros módulos
...
def forecast_120d(df_hist_joined: pd.DataFrame, 
    ...
    # Limpieza CRÍTICA del índice ANTES de reindexar
